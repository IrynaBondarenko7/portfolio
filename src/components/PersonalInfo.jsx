  ...
  return (
    <>
      ...
      <h2 className="font-serif  xl:text-xl text-sm">
        ...
        under cover. My first language? JavaScript. And my first words? “Hello,
        world!”. I come equipped with skills like safeguarding commercial
        secrets, mastering team dynamics, and the art of meaningful
        conversation. All of this, honed through a keen eye for detail,
        relentless motivation, and a knack for quick adaptation. I am dedicated
        to leveraging my skills to drive innovative solutions and contribute to
