          ...
          <TabGroup>
            <TabList className="flex gap-4 justify-center">
              {projectsData.map(({ type }) => (
                <Tab
                  key={type}
                  className="rounded-full py-1 px-3 text-sm/6 xl:text-base 2xl:text-xl font-semibold text-white focus:outline-none data-[selected]:bg-white/10 data-[hover]:bg-white/5 data-[selected]:data-[hover]:bg-white/10 data-[focus]:outline-1 data-[focus]:outline-white"
                >
                  {type}
                </Tab>
              ))}
