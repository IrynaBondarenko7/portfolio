    ...
    <section className="mt-28 md:mt-36 xl:mt-52 2xl:mt-48 xl:pb-4 relative">
      <div className=" flex items-start justify-start gap-20 md:gap-8 xl:gap-20">
        <div className="flex flex-col  gap-20 xl:gap-36 md:gap-28 items-center w-16 md:w-24 xl:w-32 2xl:w-36">
          ...
          >
            <span className="text-minorTextColor text-6xl md:text-8xl xl:text-9xl 2xl:text-[140px] font-bona-nova leading-[0.5] md:leading-[0.5] xl:leading-[0.5]">
              07
            </span>
            <span className="font-dancing-script italic md:ml-6 text-minorTextColor text-xl 2xl:text-2xl">
              January
            </span>
          </motion.p>
          <motion.div
